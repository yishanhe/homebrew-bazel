class BazelAT500 < Formula
    ...
    url "https://releases.bazel.build/5.0.0/release/bazel-5.0.0-installer-darwin-x86_64.sh", :using => :nounzip
    version "5.0.0"
    sha256 "d6f244a81f46f8026b135ccf1387a965b9de42ed219685bd5ac9ef7d1347cf85"
